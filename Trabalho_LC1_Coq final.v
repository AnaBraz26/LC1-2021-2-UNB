...
Ltac bdall :=
  ...
  forall (V : Type) (t : tree V) (k k': key) (v: V),  k <> k' -> bound k' (insert k v t) = bound  k' t.
  Proof.
   induction t.
   - intros.
     bdall.
  ...
  - intros.
    ...
    + bdall.
      ...
      auto.
      inv H.
      assert (H4: forall x,  In x (elements t1) -> (fun '(a, _) => a < k0) x).
      apply Forall_forall.
      apply elements_preserves_forall in H8.
      unfold uncurry in H8.
      assumption.
      apply H4 in H1.
      try lia.
      split.
    ...
    + simpl in H1.
      ...
      * inv H.
        simpl.
        bdall.
        assert (H4 : forall x, In x(elements t2) -> (fun '(a, _) => a > k0) x).
        apply Forall_forall.
        apply elements_preserves_forall in H7.
        unfold uncurry in H7.
        assumption.
        apply H4 in H1.
        try lia.
        constructor.
  ...
  Lemma elements_aux_app: forall (V : Type) (t : tree V) l1 l2, elements_aux t 
  l1 ++ l2 = elements_aux t (l1 ++ l2).
  Proof.
    induction t.
    - intros l1 l2.
      reflexivity.
  ...
  Qed.    
    ...
    - unfold elements_tr.
      reflexivity.
    - unfold elements_tr in *.
      simpl.
      rewrite <- IHt1.
      rewrite <- IHt2.
      rewrite elements_aux_app.
      reflexivity.
  Qed.    
